...
class CreateDefaultRoles(Command):
    ...
    DESCRIPTION = ('Creates the default IAM role ' +
                   ...
                   '\nIf you do not have a Service Role and Instance Procfile '
                   ...
                   'or Instance Procfile, create-default-roles will not '
    ...
    def _run_main_command(self, parsed_args, parsed_globals):
        ...
        # Create default EC2 Instance Procfile for EMR if it does not exist.
